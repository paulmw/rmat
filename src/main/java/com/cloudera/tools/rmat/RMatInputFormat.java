...
public class RMatInputFormat extends InputFormat<Edge, NullWritable> {
	...
	public static void setDistribution(Configuration conf, float p0, float p1, float p2) {
		conf.setFloat("rmat.p0", p0);
		conf.setFloat("rmat.p1", p1);
		conf.setFloat("rmat.p2", p2);
	}
